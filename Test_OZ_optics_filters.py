...
TYPE = "\Test_filter_" + str(filestamp)
DATADIR = r"C:\\Users\\Experience\Desktop\\Multipartite Entanglement Experiment\\Data\\Filters"+TYPE
...
sens_params = ":SENS:SENS 3;:SENS:WAV:STAR 1548nm;:SENS:WAV:STOP 1552nm;:SENS:BAND NAT;:SENS:TIME:INT:ENAB 0\r\n"
...
try:
    ...
    for iter, freq in enumerate(f_list):
        ...
        time.sleep(5)
        osa.stop_acquire()
        osa.save_data(DATADIR, "TEST_", f"signal_{w_list[iter]}", 0, PARAMS, PEAKS)
